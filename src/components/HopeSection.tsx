  ...
  return (
    ...
    >
      ...
      <div className="w-full pl-6 sm:pl-10 md:pl-16 lg:pl-20 xl:pl-28 2xl:pl-36 pr-6 sm:pr-10 md:pr-14 lg:pr-0">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-12 xl:gap-16 2xl:gap-20">
          
          {/* Left Area: Headline + Two-Column Text Composition */}
          <div className="flex-1 min-w-0 pr-0 lg:pr-6 xl:pr-12 pt-0 lg:pt-24 xl:pt-[110px] 2xl:pt-[120px] max-w-[920px]">
            
            {/* Primary Headline: beaufort-pro 300, 51px, line-height 67px, rgb(43, 43, 43) */}
            <h2
              id="hope-headline"
              className="font-beaufort text-[32px] sm:text-[38px] md:text-[44px] lg:text-[51px] leading-[42px] sm:leading-[50px] md:leading-[58px] lg:leading-[67px] text-[rgb(43,43,43)] font-[300] tracking-[-0.01em] text-left max-w-[800px]"
            >
              <span className="block whitespace-normal sm:whitespace-nowrap">You’re holding onto hope that life</span>
              <span className="block whitespace-normal sm:whitespace-nowrap">can be better than it is right now.</span>
            </h2>

            {/* Two-Column Text Grid: vertical gap from headline matches reference image */}
            <div className="mt-8 sm:mt-10 lg:mt-[52px] grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-12 xl:gap-14 text-left items-start">
              
              {/* Left Column: Uppercase Subhead + Paragraph 1 */}
              <div className="flex flex-col justify-start w-full max-w-[440px]">
                <p
                  id="hope-subhead"
                  className="font-muli text-[14px] sm:text-[14.5px] lg:text-[15px] uppercase tracking-[0.11em] text-[rgb(43,43,43)] font-normal leading-[24px] lg:leading-[25px]"
                >
                ...
                <p
                  id="hope-paragraph-1"
                  className="mt-5 lg:mt-6 font-muli text-[15.5px] lg:text-[16px] leading-[28px] lg:leading-[29px] text-[rgb(43,43,43)] font-[300]"
                >
              ...
              {/* Right Column: Paragraph 2 (matches body font Muli 300, 16px, line-height 29px) */}
              <div className="flex flex-col justify-start w-full max-w-[445px]">
                <p
                  id="hope-paragraph-2"
                  className="font-muli text-[15.5px] lg:text-[16px] leading-[28px] lg:leading-[29px] text-[rgb(43,43,43)] font-[300]"
                >
          ...
          <div className="w-full sm:w-[480px] md:w-[540px] lg:w-[31vw] lg:min-w-[380px] lg:max-w-[500px] xl:max-w-[530px] 2xl:max-w-[560px] flex-shrink-0 self-center lg:self-start">
            <div className="w-full h-[440px] sm:h-[500px] md:h-[550px] lg:h-[590px] xl:h-[615px] 2xl:h-[640px] overflow-hidden relative">
              <img
                id="hope-ocean-image"
