    ...
    >
      <div className="w-full mx-auto pl-0 pr-0 sm:px-4 md:px-6 lg:px-0">
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch justify-between gap-10 lg:gap-0">
          ...
          <div className="hidden lg:flex w-[110px] xl:w-[150px] 2xl:w-[185px] shrink-0 items-end pb-6 xl:pb-10">
            <div className="w-full h-[340px] xl:h-[395px] 2xl:h-[435px] overflow-hidden">
              <img
                ...
                className="w-full h-full object-cover object-[50%_bottom] opacity-100 contrast-[1.08] saturate-[1.06] brightness-[0.98] hover:scale-[1.02] transition-transform duration-500"
                loading="lazy"
              />
            </div>
          </div>
          ...
          <div className="w-full flex-1 max-w-[680px] xl:max-w-[760px] 2xl:max-w-[820px] lg:ml-6 xl:ml-12 2xl:ml-20 flex flex-col justify-center text-left py-4 sm:py-6 lg:py-8 px-6 sm:px-10 md:px-12 lg:px-2 xl:px-4">
            {/* Eyebrow Label */}
            ...
            <h2
              ...
              className="text-[23px] min-[420px]:text-[26px] sm:text-[30px] md:text-[33px] lg:text-[32px] xl:text-[37px] 2xl:text-[41px] text-[rgb(43,43,43)] font-[300] leading-[1.25] mb-10 sm:mb-12 lg:mb-14 xl:mb-16"
            ...
            >
              ...
              <span className="inline-flex items-baseline whitespace-nowrap mt-1">
                <span>fit for</span>
                <span
                  className="font-[300] not-italic text-[rgb(134,179,179)] text-[37px] min-[420px]:text-[41px] sm:text-[46px] md:text-[50px] lg:text-[48px] xl:text-[54px] 2xl:text-[58px] leading-[0.8] inline-block ml-2.5 sm:ml-3 select-none align-baseline"
            ...
            <p
              id="appointment-body"
              className="text-[13.5px] sm:text-[14px] lg:text-[14px] xl:text-[14.5px] leading-[1.8] text-[rgb(43,43,43)] font-[300] mb-5 sm:mb-6"
              style={{ fontFamily: "'Muli', 'Mulish', sans-serif" }}
            >
            ...
            <p
              ...
              className="text-[13.5px] sm:text-[14px] lg:text-[14px] xl:text-[14.5px] leading-[1.7] text-[rgb(43,43,43)] font-[300] mb-8 sm:mb-10 lg:mb-12 whitespace-normal sm:whitespace-nowrap"
              style={{ fontFamily: "'Muli', 'Mulish', sans-serif" }}
            >
          ...
          <div className="w-full lg:w-[30%] xl:w-[31%] 2xl:w-[32%] shrink-0 flex items-center justify-end px-4 sm:px-6 lg:px-0">
            <div className="w-full max-w-[440px] sm:max-w-[480px] lg:max-w-none h-[380px] sm:h-[440px] md:h-[480px] lg:h-[500px] xl:h-[530px] 2xl:h-[560px] overflow-hidden">
              <img
